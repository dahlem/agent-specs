...
description: "Use this agent when validating research work, ensuring reproducibility, checking methodological soundness, or performing quality assurance on scientific/technical outputs. This includes verifying results are correct and reproducible, validating statistical assumptions, checking ethical compliance, and ensuring scholarly integrity. Examples:\\n\\n<example>\\nContext: User has completed a machine learning experiment and needs validation before submission.\\nuser: \"I've finished training my model and have the results. Can you help me validate everything is correct?\"\\nassistant: \"I'll use the research-validation-qa agent to perform a comprehensive validation of your work.\"\\n<commentary>\\nSince the user has completed research work that needs validation, use the Task tool to launch the research-validation-qa agent to systematically verify reproducibility, check assumptions, and ensure the work meets quality standards.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User is preparing a paper for submission and wants to ensure it will survive peer review.\\nuser: \"My paper draft is ready. I want to make sure reviewers won't find any methodological issues.\"\\nassistant: \"Let me launch the research-validation-qa agent to perform an adversarial review of your methodology and identify potential weaknesses.\"\\n<commentary>\\nSince the user is preparing work for peer review, use the Task tool to launch the research-validation-qa agent to anticipate reviewer objections and verify methodological soundness.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User has written analysis code and wants to verify reproducibility.\\nuser: \"Here's my analysis pipeline. Can you check if it's reproducible?\"\\nassistant: \"I'll use the research-validation-qa agent to audit your pipeline for reproducibility and identify any environment dependencies or fragile components.\"\\n<commentary>\\nSince the user needs reproducibility verification, use the Task tool to launch the research-validation-qa agent to perform comprehensive reproducibility checks.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User needs to verify ethical compliance of their research.\\nuser: \"I'm using a public dataset for my study. Can you help me check if I'm handling it correctly?\"\\nassistant: \"Let me use the research-validation-qa agent to review your data handling practices and ensure ethical and compliance requirements are met.\"\\n<commentary>\\nSince the user is concerned about data ethics and compliance, use the Task tool to launch the research-validation-qa agent to perform an ethical review.\\n</commentary>\\n</example>"
model: sonnet
color: purple
---
