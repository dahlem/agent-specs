...
description: "Use this agent when the user needs to write, structure, review, or refine academic research papers with rigorous narrative architecture. This includes drafting sections, evaluating structural coherence, checking if sections answer the four core narrative questions (why exists, what gap, how addressed, so what), ensuring progressive elaboration across the document, or validating that the paper follows the nested narrative arc from big picture through implications. Examples of when to invoke this agent:\\n\\n<example>\\nContext: The user has just finished drafting their methods section and wants feedback on its structure.\\nuser: \"I just wrote my methods section, can you review it?\"\\nassistant: \"I'm going to use the Task tool to launch the paper-structure-architect agent to evaluate your methods section against the structural requirements.\"\\n<commentary>\\nSince the user is requesting review of a paper section, use the paper-structure-architect agent to analyze whether the methods section follows the constraint → necessity → construction → consequence flow and ensures all objects are introduced only when needed.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user is starting to write a new research paper and needs to establish the global narrative architecture.\\nuser: \"I'm starting to write my paper on a new optimization algorithm. Where should I begin?\"\\nassistant: \"I'm going to use the Task tool to launch the paper-structure-architect agent to help you establish the narrative contract and global architecture before writing any section.\"\\n<commentary>\\nSince the user is beginning a new paper, use the paper-structure-architect agent to ensure they establish the four core narrative questions at the paper level before proceeding to individual sections.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user has a complete draft and wants to verify the paper meets publication standards.\\nuser: \"My paper draft is complete. Is it ready for submission?\"\\nassistant: \"I'm going to use the Task tool to launch the paper-structure-architect agent to run the paper-level definition of done checklist and verify structural coherence.\"\\n<commentary>\\nSince the user has a complete draft ready for review, use the paper-structure-architect agent to validate that the narrative arc is consistent at all scales, theory emerges from necessity, and every section answers why it exists.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user is writing their abstract and wants guidance.\\nuser: \"Help me write the abstract for my machine learning paper\"\\nassistant: \"I'm going to use the Task tool to launch the paper-structure-architect agent to guide you through abstract construction following the lossless compression principle.\"\\n<commentary>\\nSince the user needs help with a specific paper section, use the paper-structure-architect agent to ensure the abstract starts with the structural problem, names the gap, states the core idea without notation, specifies what is new, and ends with implications.\\n</commentary>\\n</example>"
model: sonnet
color: purple
---
